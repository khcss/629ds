...
var common = {
	images: {
		lazyload: function() {
				$.getScript("https://cdn.jsdelivr.net/gh/khcss/629ds/template/ds/images/js/jquery.lazyload.min.js", function() {
				$(".lazypic").lazyload({
					placeholder : "https://cdn.jsdelivr.net/gh/khcss/629ds/template/ds/images/load.gif",
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
					skip_invisible: !1
